import{_ as e,p as i,q as n,Z as a}from"./framework-4bf64526.js";const d="/延迟函数的设置.png",s={},l=a(`<hr><h2 id="延迟子函数的形式" tabindex="-1"><a class="header-anchor" href="#延迟子函数的形式" aria-hidden="true">#</a> 延迟子函数的形式</h2><p>因为使用延迟的时候对延迟的精确度并不是非常高，所以一般采用计数的方法来实现延迟。</p><h2 id="子函数代码" tabindex="-1"><a class="header-anchor" href="#子函数代码" aria-hidden="true">#</a> 子函数代码</h2><h3 id="自定义延迟子函数" tabindex="-1"><a class="header-anchor" href="#自定义延迟子函数" aria-hidden="true">#</a> 自定义延迟子函数</h3><ul><li>cpu每数500个数大约是1ms</li></ul><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>void delayms(int x)	  
{
char i;
while(x--)
 {
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,14),r=[l];function c(t,v){return i(),n("div",null,r)}const u=e(s,[["render",c],["__file","yanchihanshu.html.vue"]]);export{u as default};
